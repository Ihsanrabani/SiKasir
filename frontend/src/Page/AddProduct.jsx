            ...
            <>
                ...
                <section className='h-screen flex flex-col justify-center md:mx-32 xl:mx-[500px]'>
                    <div className='flex flex-col items-center text-center px-16'>
                        <h1 className='montserrat-semibold text-3xl'>Tambah Produk</h1>
                    </div>

                    <div className='px-10 mt-7 flex flex-col gap-7'>
                        <form onSubmit={addProduct} action="" className='flex flex-col gap-4'>
                            ...
                            <div className='flex flex-col w-full'>
                                ...
                                <input id="" onChange={(e) => { setStok(e.target.value) }} type="number" className='border-SKSBLUE-1 p-2 rounded-md' placeholder='100' />
                            </div>
